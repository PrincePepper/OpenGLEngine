...
struct EnumStringMaker {
  static std::string convert(const T &t) {
    return ::Catch::Detail::stringify(static_cast<typename std::underlying_type<
        T>::type>(t));
  }
};
...
class BinaryExpr : public ITransientExpression {
  ...
  void streamReconstructedExpression(std::ostream &os) const override {
    formatReconstructedExpression
        (os, Catch::Detail::stringify(m_lhs), m_op, Catch::Detail::stringify(
            m_rhs));
  }
...
class ExprLhs {
 ...
 public:
  ...
  auto operator==(RhsT const &rhs) -> BinaryExpr<LhsT, RhsT const &> const {
    return BinaryExpr<LhsT, RhsT const &>(compareEqual(m_lhs, rhs),
                                          m_lhs,
                                          "==",
                                          rhs);
  }
  ...
  template<typename RhsT>
  auto operator!=(RhsT const &rhs) -> BinaryExpr<LhsT, RhsT const &> const {
    return BinaryExpr<LhsT, RhsT const &>(compareNotEqual(m_lhs, rhs),
                                          m_lhs,
                                          "!=",
                                          rhs);
  }
...
std::vector<TestCase> sortTests(IConfig const &config,
  ...
  switch (config.runOrder()) {
    case RunTests::InLexicographicalOrder: std::sort(sorted.begin(),
                                                     sorted.end());
      break;
...
ITrackerPtr TrackerBase::findChild(NameAndLocation const &nameAndLocation) {
  auto it = std::find_if(m_children.begin(), m_children.end(), TrackerHasName(
      nameAndLocation));
   ...
   public:
    ...
    void print() {
      ...
      switch (result.getResultType()) {
        case ResultWas::Ok: printResultType(Colour::ResultSuccess,
                                            passedString());
        ...
        case ResultWas::ExpressionFailed:
          ...
          printRemainingMessages();
          break;
        case ResultWas::ThrewException: printResultType(Colour::Error,
                                                        failedString());
          ...
          printRemainingMessages();
          break;
        case ResultWas::FatalErrorCondition: printResultType(Colour::Error,
                                                             failedString());
          ...
          printRemainingMessages();
          break;
        case ResultWas::DidntThrowException: printResultType(Colour::Error,
                                                             failedString());
        ...
        case ResultWas::Warning:printResultType(Colour::None, "warning");
          ...
          printRemainingMessages();
          break;
        case ResultWas::ExplicitFailure: printResultType(Colour::Error,
                                                         failedString());
        ...
        case ResultWas::Exception: printResultType(Colour::Error,
                                                   "** internal error **");
          break;
      }
    }
...
struct ConsoleReporter : StreamingReporterBase<ConsoleReporter> {
  ...
  bool assertionEnded(AssertionStats const &_assertionStats) override {
    ...
    bool
        includeResults = m_config->includeSuccessfulResults() || !result.isOk();
